...
class NextDiT_CLIP_CNN(NextDiT_CLIP):
    def __init__(self, *args, **kwargs):
        ...
        self.cnn_encoder = CNNEncoder(
            ...
            out_channels=cnn_base_channels*2
        )
...
def NextDiT_2B_GQA_patch2_Adaln_Refiner_WHIT_CLIP(**kwargs):
    return NextDiT_CLIP(
        patch_size=2,
        dim=2304,
        n_layers=30, #26
...
def NextDiT_2B_GQA_patch2_Adaln_Refiner_WITH_CLIP_CNN(**kwargs):
    return NextDiT_CLIP_CNN(
        patch_size=2,
        dim=2304,
        n_layers=26,
        n_heads=24,
